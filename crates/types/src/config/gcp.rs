...
/// has no effect until restart. Restate logs and ignores the change because already-constructed
/// credentials retain the AWS federation identity used at construction.
///
